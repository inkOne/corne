...
#define SPC_SYM LT(LAYER_SYM, KC_SPC) //own
#define BSPC_NUM LT(LAYER_NUM, KC_BSPC)
#define BSP_MET LT(LAYER_METAL, KC_BSPC)
...
#define LAYOUT_LAYER_BASE_BEPO KC_LAYOUT_wrapper(               \
    ...
    Z,X,C,V,B,N,M,COMM,DOT,SLSH, \
                TAB_NAV, SPC_SYM,    ENT_MBO, BSP_MET)
...
#define ______________HOME_ROW_GASC_L______________ KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,    U_NA //not used
#define ______________HOME_ROW_CGAS_L______________ KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT,    U_NA
...
#define ______________HOME_ROW_CGAS_R______________ KC_RCTL, KC_RGUI, KC_RALT, KC_RSFT,    U_NA
...
/*#define LAYOUT_LAYER_MBO                                                                      \
    ...
    ______________HOME_ROW_CGAS_L______________, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_BSPC, \
...
#define LAYOUT_LAYER_MBO                                                                      \
    ...
    ______________HOME_ROW_CGAS_L______________, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_BSPC, \
    KC_BTN3, KC_ALGR, KC_BTN2, KC_BTN1,    U_NA,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DEL, \
                                  U_NA,    KC_ESC,  U_NA,  U_NA
...
#define LAYOUT_LAYER_MEDIA                                                                    \
    ________________HOME_ROW_NA________________, USR_RDO, USR_PST, USR_CPY, USR_CUT, USR_UND, \
    ______________HOME_ROW_CGAS_L______________,    U_NU,    MS_L,    MS_D,    MS_U,    MS_R, \
...
#define LAYOUT_LAYER_NAV                                                                      \
    ...
    ______________HOME_ROW_CGAS_L______________,    U_NU, KC_BRID,  KC_BRIU, U_NU, U_NU, \
    ______________HOME_ROW_ALGR_L______________,    U_NU,   KC_VOLD, KC_VOLU,    KC_MPRV,    KC_MNXT, \
                                  U_NA,    U_NA, KC_MSTP, KC_MPLY

// Mouse.
// DPI_MOD 15 level -- level 3 is accaptabel
#define LAYOUT_LAYER_MOUSE                                                                    \
    _______, USR_PST, USR_CPY, USR_CUT, USR_UND, USR_RDO, USR_PST, USR_CPY, USR_CUT, USR_UND, \
    _______, _______, KC_LSFT, _______, _______,    U_NU,    MS_L,    MS_D,    MS_U,    MS_R, \
...
*/
#define LAYOUT_LAYER_SYM                                                                      \
    LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), KC_DLR, KC_PERC, LSFT(KC_6), LSFT(KC_7), LSFT(KC_8), LSFT(KC_9), KC_RPRN,   \
    ______________HOME_ROW_CGAS_L______________,    LSFT(KC_RBRC), KC_BSLS, A(KC_5), A(KC_6), KC_GRV,  \
    ______________HOME_ROW_ALGR_L______________,    LSFT(KC_BSLS), LSFT(KC_EQL), A(KC_8), A(KC_9),  KC_PPLS, \
...
#define LAYOUT_LAYER_NUM                                                                      \
    ...
    KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, ______________HOME_ROW_CGAS_R______________, \
     KC_GRV,    KC_1,    KC_2,    KC_3, KC_UNDS, ______________HOME_ROW_ALGR_R______________, \
                                  KC_0, KC_MINS,    U_NA,    U_NA

// Function keys. not used
...
// Metall apostrophs - german ones...
#define LAYOUT_LAYER_METAL                                                                  \
    U_NU, U_NU, U_NU, U_NU, U_NU,       U_NU, KC_LBRC, U_NU, KC_SCLN, LSFT(KC_MINS), \
    KC_QUOT, KC_MINS, U_NU, KC_LSFT, U_NU,       U_NU, KC_RSFT, U_NU, U_NU, U_NU, \
 ...
 *
 * Expects a 10-key per row layout.  Adds support for CGAS (Ctrl, Gui, Shift, Alt)
 * home row.  The layout passed in parameter must contain at least 20 keycodes.
 *
 */
#define _HOME_ROW_MOD_CGAS(                                            \
    L00, L01, L02, L03, L04, R05, R06, R07, R08, R09,                  \
    L10, L11, L12, L13, L14, R15, R16, R17, R18, R19,                  \
    ...)                                                               \
             L00,         L01,         L02,         L03,         L04,  \
             R05,         R06,         R07,         R08,         R09,  \
      LCTL_T(L10), LGUI_T(L11), LALT_T(L12), LSFT_T(L13),        L14,  \
             R15,  RSFT_T(R16), RALT_T(R17), LGUI_T(R18), RCTL_T(R19), \
      __VA_ARGS__
#define HOME_ROW_MOD_CGAS(...) _HOME_ROW_MOD_CGAS(__VA_ARGS__)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_wrapper(
    MOUSE_MOD(HOME_ROW_MOD_CGAS(LAYOUT_LAYER_BASE_BEPO))
  ),
  ...
  [LAYER_METAL] = LAYOUT_wrapper(LAYOUT_LAYER_METAL),
